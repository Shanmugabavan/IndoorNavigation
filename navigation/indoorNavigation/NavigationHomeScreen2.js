...
const Home = ({ navigation }) => {
    ...
    const bookTheMetropolis = {
        ...
        bookCover: images.navigationPic,
        rating: 4.1,
        language: "Eng",
        pageNo: 272,
        author: "Seith Fried",
    ...
    const myBooksData = [
        {
            ...
            completion: "Find a path",
            lastRead: "3d 5h",

        },
        {
            ...bookTheMetropolis,
            completion: "Location Estimation",
            lastRead: "10d 5h",
            ...
            <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: SIZES.padding, alignItems: 'center' }}>
                ...
                <View style={{ flex: 1 }}>
                    <View style={{ marginRight: SIZES.padding }}>
                        <Text style={{ ...FONTS.h3, color: COLORS.white }}>Navigation Home</Text>
        ...
        const renderItem = ({ item, index }) => {
            return (
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate( index == 1? screenNames.LOCATION_SCREEN: screenNames.LOCATION_SELECT_SCREEN)}>

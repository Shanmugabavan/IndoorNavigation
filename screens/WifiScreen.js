            ...
            <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: SIZES.padding, alignItems: 'center' }}>
                ...
                <View style={{ flex: 1 }}>
                    <View style={{ marginRight: SIZES.padding }}>
                        <Text style={{ ...FONTS.h3, color: COLORS.white }}>WiFI Based</Text>
        ...
        const renderItem = ({ item, index }) => {
            return (
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate( index == 1? screenNames.NAVIGATION_HOME_SCREEN2: screenNames.DATA_COLLECTION_SCREEN)}>

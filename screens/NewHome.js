    ...
    const myBooksData = [
        {
            ...
            completion: "WIFI Based",
            lastRead: "3d 5h",

        },
        {
            ...bookTheMetropolis,
            completion: "IMU Based",
            lastRead: "10d 5h",
            ...
            <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: SIZES.padding, alignItems: 'center' }}>
                ...
                <View style={{ flex: 1 }}>
                    <View style={{ marginRight: SIZES.padding }}>
                        <Text style={{ ...FONTS.h3, color: COLORS.white }}>Indoor Navigation</Text>
        ...
        const renderItem = ({ item, index }) => {
            return (
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate( index == 1? screenNames.IMU_SCREEN: screenNames.WIFISCREEN)}>
